...
class toytoy:
    ...
    def L_ii (self,x):
        mu=self.mu
        return -(-2**(0.5)*pi**(0.5)*exp(-0.5*(1+mu)**2)*erf(0.5*2**(0.5)+0.5*mu*2**(0.5))+2**(0.5)*pi**(0.5)*exp(-0.5*(1+mu)**2)*erf(-0.5*2**(0.5)+0.5*mu*2**(0.5))-2**(0.5)*pi**(0.5)*exp(-0.5*(-1+mu)**2)*erf(0.5*2**(0.5)+0.5*mu*2**(0.5))+2**(0.5)*pi**(0.5)*exp(-0.5*(-1+mu)**2)*erf(-0.5*2**(0.5)+0.5*mu*2**(0.5))-2**(0.5)*pi**(0.5)*exp(-0.5*(1+mu)**2)*mu*erf(0.5*2**(0.5)+0.5*mu*2**(0.5))+2**(0.5)*pi**(0.5)*exp(-0.5*(1+mu)**2)*mu*erf(-0.5*2**(0.5)+0.5*mu*2**(0.5))+2**(0.5)*pi**(0.5)*exp(-0.5*(-1+mu)**2)*mu*erf(0.5*2**(0.5)+0.5*mu*2**(0.5))-2**(0.5)*pi**(0.5)*exp(-0.5*(-1+mu)**2)*mu*erf(-0.5*2**(0.5)+0.5*mu*2**(0.5))+4*exp(-1-mu**2)-2*pi*erf(0.5*2**(0.5)+0.5*mu*2**(0.5))*erf(-0.5*2**(0.5)+0.5*mu*2**(0.5))-2*exp(-(1+mu)**2)-2*exp(-(-1+mu)**2)+pi*erf(0.5*2**(0.5)+0.5*mu*2**(0.5))**2+pi*erf(-0.5*2**(0.5)+0.5*mu*2**(0.5))**2)/pi/(erf(0.5*2**(0.5)+0.5*mu*2**(0.5))-erf(-0.5*2**(0.5)+0.5*mu*2**(0.5)))**2
